...
#ifndef OHOS_FORM_FWK_ANI_GETFROMCACHE_H
#define OHOS_FORM_FWK_ANI_GETFROMCACHE_H
...
class AniGetFromCache final : public DelayedRefSingleton<AniGetFromCache>  {
    DECLARE_DELAYED_REF_SINGLETON(AniGetFromCache)
public:
...
#endif // OHOS_FORM_FWK_ANI_GETFROMCACHE_H