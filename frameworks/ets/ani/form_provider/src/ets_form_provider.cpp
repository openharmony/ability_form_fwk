...
std::vector<ani_native_function> GetBindMethods()
{
    std::vector methods = {
        ...
        ani_native_function{"updateForm_inner",
            "C{std.core.String}C{std.core.String}C{std.core.Array}:", reinterpret_cast<void *>(UpdateForm)},
        ani_native_function{"getFormsInfo_inner",
            "C{@ohos.app.form.formInfo.formInfo.FormInfoFilter}:C{std.core.Array}",
