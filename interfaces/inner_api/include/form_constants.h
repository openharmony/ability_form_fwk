...
namespace Constants {
    ...
    constexpr const char* PARAM_FORM_DISPLAY_ID_KEY = "ohos.extra.param.key.form_display_id";
    ...
    constexpr const char* FORM_IS_SYSTEM_APP_KEY = "form_is_system_app";
    ...
    constexpr const char* PARAM_ENABLE_ROUTE_SECOND_PAGE = "ohos.form.action.key.enable_route_seconde_page";
