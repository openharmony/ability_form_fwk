...
#ifndef OHOS_FORM_FWK_FORM_PROVIDER_STUB_H
#define OHOS_FORM_FWK_FORM_PROVIDER_STUB_H
...
private:
    ...
    /**
     * @brief Handle request provider share form info message.
     * @param data input param.
     * @param reply output param.
     * @return Returns ERR_OK on success, others on failure.
     */
    ...
    /**
     * @brief Handle request provider adquire form data.
     * @param data input param.
     * @param reply output param.
     * @return Returns ERR_OK on success, others on failure.
     */
    ...
    /**
     * @brief Handle NotifySizeChanged message.
     * @param data input param.
     * @param reply output param.
     * @return Returns ERR_OK on success, others on failure.
     */
    int32_t HandleNotifySizeChanged(MessageParcel &data, MessageParcel &reply);
...
#endif  // OHOS_FORM_FWK_FORM_PROVIDER_STUB_H
