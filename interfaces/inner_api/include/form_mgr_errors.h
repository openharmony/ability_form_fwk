...
enum {
    ...
    ERR_APPEXECFWK_FORM_EDIT_UNSUPPORT_OPERATION, //2293844
    ERR_APPEXECFWK_LIVE_FORM_IS_OVERFLOWING,
    ERR_APPEXECFWK_LIVE_FORM_DEVICE_STATUS_ERROR, // 2293846
    ERR_APPEXECFWK_LIVE_FORM_HOST_STATUS_ERROR,
    ERR_APPEXECFWK_LIVE_FORM_OVERFLOW_COMPETITION_FAILED,
    ERR_APPEXECFWK_LIVE_FORM_OVERFLOW_PARAMS_ERROR, // 2293849
};
