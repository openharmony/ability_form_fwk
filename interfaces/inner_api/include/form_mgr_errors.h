...
enum {
    ...
    ERR_APPEXECFWK_FORM_STATUS_TIME_OUT, // 2293817
    ...
    ERR_APPEXECFWK_FORM_LIVE_OP_PAGE_INFO_MISMATCH, // 2293835
    ...
    ERR_APPEXECFWK_CALLING_NOT_UI_ABILITY, // 2293844
    ERR_APPEXECFWK_LIVE_FORM_IS_ACTIVING,
    ERR_APPEXECFWK_LIVE_FORM_POWER_MODE_ERROR,
    ERR_APPEXECFWK_LIVE_FORM_HOT_CONTROL, // 2293847
    ...
    ERR_APPEXECFWK_FORM_PUBLISH_HOST_FORM_LIMIT,
    // error code in distributed form service discovery
    ERR_APPEXECFWK_FORM_SERVICE_DM_UNAVAILABLE, // 2293861
    ...
    ERR_APPEXECFWK_FORM_CD_SOFTBUS_UNAVAILABLE,  // 2293865
...
enum {
    ...
    ERR_FORM_EXTERNAL_FORM_STATUS_TIME_OUT = 16501009,
    ...
    ERR_FORM_EXTERNAL_FORM_LOCATION_INVALID = 16501016,
    ERR_FORM_EXTERNAL_PUBLISH_NO_SPACE = 16501017,
    ERR_FORM_EXTERNAL_PUBLISH_NOT_SUPPORT = 16501018,
    ERR_FORM_EXTERNAL_SERVICE_NOT_SELF = 16501019,
    ERR_FORM_EXTERNAL_CD_PEER_SERVICE_UNAVAILABLE = 16501020,
    ERR_FORM_EXTERNAL_CD_PEER_APP_NOT_INSTALLED = 16501021,
};
}  // namespace OHOS
