...
#ifndef OHOS_FORM_FWK_FORM_PROVIDER_PROXY_H
#define OHOS_FORM_FWK_FORM_PROVIDER_PROXY_H
...
private:
    ...
    int SendTransactCmd(IFormProvider::Message code, MessageParcel &data,
...
#endif  // OHOS_FORM_FWK_FORM_PROVIDER_PROXY_H
