...
#ifndef OHOS_FORM_FWK_FORM_PROVIDER_INTERFACE_H
#define OHOS_FORM_FWK_FORM_PROVIDER_INTERFACE_H
...
public:
     ...
     * @return Returns ERR_OK on success, others on failure.
     */
    virtual int NotifySizeChanged(const int64_t formId, const std::string &newDimension, const Rect &newRect,
    ...
    enum class Message {
        ...
        // ipc id for system config update notify (3061)
        FORM_PROVIDER_NOTIFY_CONFIGURATION_UPDATE,
...
#endif // OHOS_FORM_FWK_FORM_PROVIDER_INTERFACE_H
