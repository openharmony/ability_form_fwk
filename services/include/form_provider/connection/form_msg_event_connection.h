...
#ifndef OHOS_FORM_FWK_FORM_MSG_EVENT_CONNECTION_H
...
public:
    FormMsgEventConnection(const int64_t formId, const Want &want, const std::string &bundleName,
...
#endif // OHOS_FORM_FWK_FORM_MSG_EVENT_CONNECTION_H
