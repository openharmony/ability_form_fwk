...
public:
    ...
    */
     ...
     * @param formId formId Indicates the unique id of form.
     * @param isUnusedInclude Indicates whether to include unused form instances.
     * @param formInstance return formInstance
     * @return return ERR_OK on get info success, others on failure.
     */
    ErrCode GetFormInstanceById(const int64_t formId, bool isUnusedInclude, FormInstance &formInstance) override;
