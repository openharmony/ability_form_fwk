...
#ifndef OHOS_FORM_FWK_MULTI_ACTIVE_USERS_CHECKER_H
#define OHOS_FORM_FWK_MULTI_ACTIVE_USERS_CHECKER_H
...
public:
    DISALLOW_COPY_AND_MOVE(MultiActiveUsersChecker);
...
#endif // OHOS_FORM_FWK_MULTI_ACTIVE_USERS_CHECKER_H