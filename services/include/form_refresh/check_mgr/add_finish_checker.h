...
#ifndef OHOS_FORM_FWK_ADD_FINISH_CHECKER_H
#define OHOS_FORM_FWK_ADD_FINISH_CHECKER_H
...
public:
    DISALLOW_COPY_AND_MOVE(AddFinishChecker);
...
#endif // OHOS_FORM_FWK_ADD_FINISH_CHECKER_H