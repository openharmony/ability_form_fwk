...
#ifndef OHOS_FORM_FWK_FORM_RENDER_SERIAL_QUEUE_H
#define OHOS_FORM_FWK_FORM_RENDER_SERIAL_QUEUE_H
...
class FormRenderSerialQueue final {
public:
...
#endif // OHOS_FORM_FWK_FORM_RENDER_SERIAL_QUEUE_H
