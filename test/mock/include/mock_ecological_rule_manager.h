...
public:
    ...
    MOCK_METHOD3(QueryStartExperience, int32_t(const Want &want, const ErmsParams::CallerInfo &callerInfo,
        ErmsParams::ExperienceRule &rule));
    MOCK_METHOD2(QueryPublishFormExperience, int32_t(const Want &want, ErmsParams::ExperienceRule &rule));
    MOCK_METHOD3(IsSupportPublishForm, int32_t(const Want &want, const ErmsParams::CallerInfo &callerInfo,
        ErmsParams::ExperienceRule &rule));
