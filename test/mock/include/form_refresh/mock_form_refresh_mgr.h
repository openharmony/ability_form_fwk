...
#ifndef OHOS_FORM_FWK_MOCK_FORM_REFRESH_MGR_H
#define OHOS_FORM_FWK_MOCK_FORM_REFRESH_MGR_H
...
class AbstractMockFormRefreshMgr {
public:
...
public:
    static std::shared_ptr<MockFormRefreshMgr> obj;
...
#endif  // OHOS_FORMFORM_FWK_MOCK_FORM_REFRESH_MGR_H
