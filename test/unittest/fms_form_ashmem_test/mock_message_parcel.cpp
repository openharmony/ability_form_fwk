...
namespace {
    ...
    bool g_mockWriteAshmem = true;
    bool g_mockReadFileDescriptor = true;
}
...
void MockWriteAshmem(bool mockRet)
{
    g_mockWriteAshmem = mockRet;
}

void MockReadFileDescriptor(bool mockRet)
{
    g_mockReadFileDescriptor = mockRet;
}
...
{
    return g_mockReadFileDescriptor;
}
