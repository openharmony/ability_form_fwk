...
/**
 * @tc.number: FmsFormProviderDataTest_0051
 * @tc.name: Verify the CheckAshmemSize function.
 * @tc.desc: Verify whether the CheckAshmemSize interface calls normally.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0051, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0051 start";
    int fd = -1;
    int32_t bufferSize = 0;
    bool isAstc = false;
    auto result =  FormProviderData::CheckAshmemSize(fd, bufferSize, isAstc);
    EXPECT_EQ(result, false);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0051 end";
}
 
/**
 * @tc.name: FmsFormProviderDataTest_052
 * @tc.desc: Verify the CreateJsonFileByJsonData1 function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_052, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_052 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    EXPECT_EQ(true, CreateJsonFileByJsonData1(formProviderData.jsonFormProviderData_));
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_052 end";
}
 
/**
 * @tc.name: FmsFormProviderDataTest_053
 * @tc.desc: Verify the CreateJsonFileByJsonData2 function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_053, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_053 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_.dump());
    EXPECT_EQ(true, CreateJsonFileByJsonData2(formProviderData.jsonFormProviderData_));
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_053 end";
}
 
/**
 * @tc.name: FmsFormProviderDataTest_054
 * @tc.desc: Verify the GetDataString function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_054, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_054 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    GTEST_LOG_(INFO) << "print:" <<formProviderData.GetDataString();
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_054 end";
}
 
/**
 * @tc.name: FmsFormProviderDataTest_055
 * @tc.desc: Verify the MergeData function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_055, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_055 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    EXPECT_EQ(true, InitJsonData2());
    formProviderData.MergeData(jsonData_);
    EXPECT_EQ(true, CreateMergeJsonFileByJsonData3(formProviderData.jsonFormProviderData_));
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_055 end";
}
 
/**
 * @tc.name: FmsFormProviderDataTest_056
 * @tc.desc: Verify the ConvertRawImageData function.
 * @tc.type: FUNC
 * @tc.require: issueI5KIZC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_056, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_056 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    std::string picName = "image";
    char* bytes = new char[1];
    ...
    EXPECT_TRUE(formProviderData.ConvertRawImageData());
    EXPECT_EQ(1, formProviderData.GetImageDataMap().size());
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_056 end";
}
 
/**
 * @tc.name: FmsFormProviderDataTest_057
 * @tc.desc: Verify the AddImageData and WriteImageDataToParcel function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_057, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_057 start";
    FormProviderData formProviderData(jsonData_);
    std::string picName = "image";
    formProviderData.AddImageData(picName, 1);
    Parcel parcel;
    ...
    std::shared_ptr<char> data(bytes);
    EXPECT_EQ(true, formProviderData.WriteImageDataToParcel(parcel, picName, data, 1));
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_057 end";
}

/**
 * @tc.name: FmsFormProviderDataTest_058
 * @tc.desc: Verify the UpdateData and GetData function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_058, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_058 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    formProviderData.UpdateData(jsonData_);
    auto result = formProviderData.GetData();
    ...
    EXPECT_EQ(jsonData_, result);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_058 end";
}
 
/**
 * @tc.name: FmsFormProviderDataTest_059
 * @tc.desc: Verify the RemoveImageData and AddImageData function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_059, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_059 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    std::string picName = "abc";
    int32_t size = 1;
    ...
    EXPECT_TRUE(formProviderData.rawImageBytesMap_.empty());
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_059 end";

}
 
/**
 * @tc.name: FmsFormProviderDataTest_060
 * @tc.desc: Verify the SetDataString and GetDataString function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_060, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_060 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    std::string jsonDataString = "abc";
    formProviderData.SetDataString(jsonDataString);
    ...
    EXPECT_FALSE(result.empty());
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_060 end";

}

/**
 * @tc.number: FmsFormProviderDataTest_0061
 * @tc.name: Verify the ReadFromParcel function.
 * @tc.desc: When the parameter parcel is 100, the interface return value is true.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0061, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0061 start";
    EXPECT_EQ(true, InitJsonData());
    constexpr int32_t defaultValue = 100;
    FormProviderData formProviderData(jsonData_);
    Parcel parcel;
    ...
    auto result = formProviderData.ReadFromParcel(parcel);
    EXPECT_TRUE(result);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0061 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0062
 * @tc.name: Verify the ReadFromParcel function.
 * @tc.desc: When the parameter parcel is IMAGE_DATA_STATE_ADDED, the interface return value is true.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0062, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0062 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    Parcel parcel;
    parcel.WriteInt32(DEFAULT_VALUE);
    ...
    auto result = formProviderData.ReadFromParcel(parcel);
    EXPECT_TRUE(result);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0062 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0063
 * @tc.name: Verify the ReadFromParcel function.
 * @tc.desc: When the parameter parcel is IMAGE_DATA_STATE_ADDED and imageDataNum is exception value, the
 *           interface return value is false.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0063, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0063 start";
    EXPECT_EQ(true, InitJsonData());
    constexpr int32_t imageDataNum = 1001;  // 1001: Eead parcel max image data num size.
    FormProviderData formProviderData(jsonData_);
    Parcel parcel;
    ...
    auto result = formProviderData.ReadFromParcel(parcel);
    EXPECT_FALSE(result);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0063 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0064
 * @tc.name: Verify the ReadFromParcel function.
 * @tc.desc: When the parameter parcel is IMAGE_DATA_STATE_ADDED and imageDataNum is normal value, the
 *           interface return value is false.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0064, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0064 start";
    EXPECT_EQ(true, InitJsonData());
    constexpr int32_t imageDataNum = 1;
    constexpr int32_t len = 0;
    FormAshmem formAshmem;
    ...
    auto result = formProviderData.ReadFromParcel(parcel);
    EXPECT_FALSE(result);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0064 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0065
 * @tc.name: Verify the ReadFromParcel function.
 * @tc.desc: When the parameter parcel is IMAGE_DATA_STATE_ADDED and imageDataNum is normal value, the
 *           interface return value is false.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0065, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0065 start";
    EXPECT_EQ(true, InitJsonData());
    constexpr int32_t imageDataNum = 1;
    FormProviderData formProviderData(jsonData_);
    Parcel parcel;
    ...
    auto result = formProviderData.ReadFromParcel(parcel);
    EXPECT_FALSE(result);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0065 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0066
 * @tc.name: Verify the Marshalling function.
 * @tc.desc: When the parameter imageDataState_ is IMAGE_DATA_STATE_NO_OPERATION, the interface return value is true.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0066, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0066 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    formProviderData.imageDataState_ = FormProviderData::IMAGE_DATA_STATE_NO_OPERATION;
    Parcel parcel;
    auto result = formProviderData.Marshalling(parcel);
    EXPECT_TRUE(result);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0066 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0067
 * @tc.name: Verify the Marshalling function.
 * @tc.desc: When the parameter imageDataState_ is IMAGE_DATA_STATE_REMOVED, the interface return value is true.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0067, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0067 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    formProviderData.imageDataState_ = FormProviderData::IMAGE_DATA_STATE_REMOVED;
    Parcel parcel;
    auto result = formProviderData.Marshalling(parcel);
    EXPECT_TRUE(result);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0067 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0068
 * @tc.name: Verify the Marshalling function.
 * @tc.desc: When the parameter imageDataState_ is IMAGE_DATA_STATE_ADDED, the interface return value is true.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0068, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0068 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    formProviderData.imageDataState_ = FormProviderData::IMAGE_DATA_STATE_ADDED;
    Parcel parcel;
    auto result = formProviderData.Marshalling(parcel);
    EXPECT_TRUE(result);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0068 end";
}
 ...
 * @tc.desc: When the parameter imageDataState_ is 100, the interface return value is true.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0069, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0069 start";
    EXPECT_EQ(true, InitJsonData());
    constexpr int32_t defaultValue = 100;
    FormProviderData formProviderData(jsonData_);
    formProviderData.imageDataState_ = defaultValue;
    ...
    auto result = formProviderData.Marshalling(parcel);
    EXPECT_TRUE(result);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0069 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0070
 * @tc.name: Verify the Marshalling function.
 * @tc.desc: When the parameter imageDataState_ is null, the interface return value is true.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0070, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0070 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData("");
    formProviderData.jsonFormProviderData_.clear();
    Parcel parcel;
    auto result = formProviderData.Marshalling(parcel);
    EXPECT_TRUE(result);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0070 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0071
 * @tc.name: Verify the ParseImagesData function.
 * @tc.desc: Verify whether the ParseImagesData interface calls normally.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0071, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0071 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    formProviderData.ParseImagesData();
    EXPECT_TRUE(formProviderData.jsonFormProviderData_ != nullptr);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0071 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0072
 * @tc.name: Verify the ParseImagesData function.
 * @tc.desc: When the jsonFormProviderData_ is nullptr, the ParseImagesData interface calls normally.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0072, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0072 start";
    FormProviderData formProviderData("");
    formProviderData.jsonFormProviderData_ = nullptr;
    formProviderData.ParseImagesData();
    EXPECT_TRUE(formProviderData.jsonFormProviderData_ == nullptr);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0072 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0073
 * @tc.name: Verify the NeedCache function.
 * @tc.desc: When the jsonFormProviderData_ is nullptr, the NeedCache interface calls normally.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0073, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0073 start";
    FormProviderData formProviderData("{'a':'1','b':'2'}");
    formProviderData.jsonFormProviderData_.clear();
    EXPECT_FALSE(formProviderData.NeedCache());
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0073 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0074
 * @tc.name: Verify the SetImageDataState function.
 * @tc.desc: Verify whether the NeedCache interface calls normally.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0074, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0074 start";
    FormProviderData formProviderData("");
    constexpr int32_t imageStage = 1000;
    EXPECT_NE(imageStage, formProviderData.imageDataState_);
    formProviderData.SetImageDataState(imageStage);
    EXPECT_EQ(imageStage, formProviderData.imageDataState_);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0074 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0075
 * @tc.name: Verify the GetImageDataState function.
 * @tc.desc: Verify whether the GetImageDataState interface calls normally.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0075, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0075 start";
    FormProviderData formProviderData("");
    formProviderData.jsonFormProviderData_.clear();
    EXPECT_EQ(formProviderData.imageDataState_, formProviderData.GetImageDataState());
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0075 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0076
 * @tc.name: Verify the WriteAshmemDataToParcel function.
 * @tc.desc: Verify whether the WriteAshmemDataToParcel interface calls normally.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0076, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0076 start";
    Parcel parcel;
    std::string name = "formAshmemData";
    size_t size = sizeof(name);
    const char* dataPtr = "formAshmemData";
    ...
    auto result = formProviderData.WriteAshmemDataToParcel(parcel, size, dataPtr);
    EXPECT_EQ(result, true);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0076 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0077
 * @tc.name: Verify the ReadAshmemDataFromParcel function.
 * @tc.desc: Verify whether the ReadAshmemDataFromParcel interface calls normally.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0077, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0077 start";
    Parcel parcel;
    size_t bufferSize = 0;
    FormProviderData formProviderData("");
    formProviderData.jsonFormProviderData_.clear();
    auto result = formProviderData.ReadAshmemDataFromParcel(parcel, bufferSize);
    EXPECT_EQ(result, nullptr);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0077 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0078
 * @tc.name: Verify the WriteFileDescriptor function.
 * @tc.desc: Verify whether the WriteFileDescriptor interface calls normally.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0078, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0078 start";
    Parcel parcel;
    int fd = -1;
    FormProviderData formProviderData("");
    formProviderData.jsonFormProviderData_.clear();
    auto result = formProviderData.WriteFileDescriptor(parcel, fd);
    EXPECT_EQ(result, false);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0078 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0079
 * @tc.name: Verify the ReadFileDescriptor and ReleaseMemory function.
 * @tc.desc: Verify whether ReadFileDescriptor and ReleaseMemory interface calls normally.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0079, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0079 start";
    Parcel parcel;
    FormProviderData formProviderData;
    formProviderData.ReleaseMemory(2, nullptr, nullptr, 0);
    auto result = formProviderData.ReadFileDescriptor(parcel);
    EXPECT_EQ(result, -1);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0079 end";
}

/**
 * @tc.number: FmsFormProviderDataTest_0080
 * @tc.name: Verify the CheckAshmemSize function.
 * @tc.desc: Verify whether the CheckAshmemSize interface calls normally.
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_0080, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0080 start";
    int fd = -1;
    int32_t bufferSize = 0;
    bool isAstc = false;
    auto result =  FormProviderData::CheckAshmemSize(fd, bufferSize, isAstc);
    EXPECT_EQ(result, false);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_0080 end";
}

/**
 * @tc.name: FmsFormProviderDataTest_081
 * @tc.desc: Verify the CreateJsonFileByJsonData1 function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_081, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_082 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    EXPECT_EQ(true, CreateJsonFileByJsonData1(formProviderData.jsonFormProviderData_));
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_082 end";
}

/**
 * @tc.name: FmsFormProviderDataTest_083
 * @tc.desc: Verify the CreateJsonFileByJsonData2 function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_083, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_083 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_.dump());
    EXPECT_EQ(true, CreateJsonFileByJsonData2(formProviderData.jsonFormProviderData_));
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_083 end";
}

/**
 * @tc.name: FmsFormProviderDataTest_084
 * @tc.desc: Verify the GetDataString function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_084, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_084 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    GTEST_LOG_(INFO) << "print:" <<formProviderData.GetDataString();
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_084 end";
}

/**
 * @tc.name: FmsFormProviderDataTest_085
 * @tc.desc: Verify the MergeData function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_085, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_085 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    EXPECT_EQ(true, InitJsonData2());
    formProviderData.MergeData(jsonData_);
    EXPECT_EQ(true, CreateMergeJsonFileByJsonData3(formProviderData.jsonFormProviderData_));
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_085 end";
}

/**
 * @tc.name: FmsFormProviderDataTest_086
 * @tc.desc: Verify the ConvertRawImageData function.
 * @tc.type: FUNC
 * @tc.require: issueI5KIZC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_086, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_086 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    std::string picName = "image";
    char* bytes = new char[1];
    ...
    EXPECT_TRUE(formProviderData.ConvertRawImageData());
    EXPECT_EQ(1, formProviderData.GetImageDataMap().size());
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_086 end";
}

/**
 * @tc.name: FmsFormProviderDataTest_087
 * @tc.desc: Verify the AddImageData and WriteImageDataToParcel function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_087, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_087 start";
    FormProviderData formProviderData(jsonData_);
    std::string picName = "image";
    formProviderData.AddImageData(picName, 1);
    Parcel parcel;
    ...
    std::shared_ptr<char> data(bytes);
    EXPECT_EQ(true, formProviderData.WriteImageDataToParcel(parcel, picName, data, 1));
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_087 end";
}
/**
 * @tc.name: FmsFormProviderDataTest_088
 * @tc.desc: Verify the UpdateData and GetData function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_088, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_088 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    formProviderData.UpdateData(jsonData_);
    auto result = formProviderData.GetData();
    ...
    EXPECT_EQ(jsonData_, result);
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_088 end";
}

/**
 * @tc.name: FmsFormProviderDataTest_089
 * @tc.desc: Verify the RemoveImageData and AddImageData function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_089, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_089 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    std::string picName = "abc";
    int32_t size = 1;
    ...
    EXPECT_TRUE(formProviderData.rawImageBytesMap_.empty());
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_089 end";

}

/**
 0* @tc.name: FmsFormProviderDataTest_090
 * @tc.desc: Verify the SetDataString and GetDataString function.
 * @tc.type: FUNC
 */
HWTEST_F(FmsFormProviderDataTest, FmsFormProviderDataTest_090, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_090 start";
    EXPECT_EQ(true, InitJsonData());
    FormProviderData formProviderData(jsonData_);
    std::string jsonDataString = "abc";
    formProviderData.SetDataString(jsonDataString);
    ...
    EXPECT_FALSE(result.empty());
    GTEST_LOG_(INFO) << "FmsFormProviderDataTest_090 end";
