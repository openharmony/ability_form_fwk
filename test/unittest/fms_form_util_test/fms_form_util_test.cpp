 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0004, TestSize.Level1)
{
    constexpr int64_t udidHash = 0x1111111100000000L;
    const int64_t result = FormUtil::GenerateFormId(udidHash);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0005, TestSize.Level1)
{
    constexpr uint64_t formId = 0x1111111100000000L;
    constexpr uint64_t udidHash = 0x0000000011111111L;
    const int64_t result = FormUtil::PaddingUdidHash(formId, udidHash);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0006, TestSize.Level1)
{
    constexpr uint64_t formId = 0x0000000011111111L;
    constexpr uint64_t udidHash = 0x1111111100000000L;
    const int64_t result = FormUtil::PaddingUdidHash(formId, udidHash);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0007, TestSize.Level1)
{
    int64_t udidHash = 0x1111111100000000L;
    auto result = FormUtil::GenerateUdidHash(udidHash);
    EXPECT_TRUE(result);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0008, TestSize.Level1)
{
    int64_t udidHash = 0;
    auto result = FormUtil::GenerateUdidHash(udidHash);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0009, TestSize.Level1)
{
    auto result1 = FormUtil::GetCurrentNanosecond();
    auto result2 = FormUtil::GetCurrentNanosecond();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0010, TestSize.Level1)
{
    auto result1 = FormUtil::GetCurrentMillisecond();
    auto result2 = FormUtil::GetCurrentMillisecond();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0011, TestSize.Level1)
{
    constexpr int64_t value = -1;
    time_t rawtime;
    time(&rawtime);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0012, TestSize.Level1)
{
    constexpr size_t accountId = 99;
    MockQueryActiveOsAccountIdsRetVal(false);
    MockQueryActiveOsAccountIdsParams(false);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0013, TestSize.Level1)
{
    constexpr size_t count = 3;
    const std::string str = "10:35:27";
    auto result = FormUtil::StringSplit(str, Constants::TIME_DELIMETER);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0014, TestSize.Level1)
{
    constexpr size_t accountId = 99;
    MockQueryActiveOsAccountIdsRetVal(true);
    MockQueryActiveOsAccountIdsParams(true);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0015, TestSize.Level1)
{
    constexpr size_t accountId = 99;
    MockQueryActiveOsAccountIdsRetVal(true);
    MockQueryActiveOsAccountIdsParams(false);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0016, TestSize.Level1)
{
    auto result1 = FormUtil::GetNowMillisecond();
    auto result2 = FormUtil::GetNowMillisecond();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0017, TestSize.Level1)
{
    std::string strInfo = "";
    int64_t int64Value = 1;
    EXPECT_TRUE(FormUtil::ConvertStringToInt64(strInfo, int64Value));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0018, TestSize.Level1)
{
    std::string strInfo = "";
    int64_t int64Value = 1;
    EXPECT_TRUE(FormUtil::ConvertStringToInt64(strInfo, int64Value));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0019, TestSize.Level1)
{
    std::string strInfo = "";
    int64_t int64Value = 1;
    EXPECT_TRUE(FormUtil::ConvertStringToInt64(strInfo, int64Value));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0020, TestSize.Level1)
{
    std::string strInfo = "";
    int64_t int64Value = 1;
    EXPECT_TRUE(FormUtil::ConvertStringToInt64(strInfo, int64Value));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0021, TestSize.Level1)
{
    std::string strInfo = "";
    int64_t int64Value = 1;
    EXPECT_TRUE(FormUtil::ConvertStringToInt64(strInfo, int64Value));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0022, TestSize.Level1)
{
    std::string strInfo = "";
    int64_t int64Value = 1;
    EXPECT_TRUE(FormUtil::ConvertStringToInt64(strInfo, int64Value));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0023, TestSize.Level1)
{
    std::string strInfo = "";
    int64_t int64Value = 1;
    EXPECT_TRUE(FormUtil::ConvertStringToInt64(strInfo, int64Value));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0024, TestSize.Level1)
{
    std::string strInfo = "";
    int64_t int64Value = 1;
    EXPECT_TRUE(FormUtil::ConvertStringToInt64(strInfo, int64Value));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0025, TestSize.Level1)
{
    std::string strInfo = "";
    int64_t int64Value = 1;
    EXPECT_TRUE(FormUtil::ConvertStringToInt64(strInfo, int64Value));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0026, TestSize.Level1)
{
    std::string strInfo = "";
    int64_t int64Value = 1;
    EXPECT_TRUE(FormUtil::ConvertStringToInt64(strInfo, int64Value));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0027, TestSize.Level1)
{
    std::string strInfo = "";
    int64_t int64Value = 1;
    EXPECT_TRUE(FormUtil::ConvertStringToInt64(strInfo, int64Value));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0028, TestSize.Level1)
{
    std::string strInfo = "";
    int64_t int64Value = 1;
    EXPECT_TRUE(FormUtil::ConvertStringToInt64(strInfo, int64Value));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormUtilTest, FormUtilTest_0029, TestSize.Level1)
{
    std::string strInfo = "";
    int64_t int64Value = 1;
    EXPECT_TRUE(FormUtil::ConvertStringToInt64(strInfo, int64Value));
...
HWTEST_F(FormUtilTest, FormUtilTest_0030, TestSize.Level1)
{
    constexpr size_t accountId = 99;
    MockQueryActiveOsAccountIdsRetVal(true);
    MockQueryActiveOsAccountIdsParams(true);
...
HWTEST_F(FormUtilTest, FormUtilTest_0031, TestSize.Level0)
{
    std::vector<int32_t> activeList;
    FormUtil::GetActiveUsers(activeList);
    EXPECT_EQ(true, activeList.empty());
