...
HWTEST_F(FormMgrTest, FormMgrTest_0018, TestSize.Level1) {
    ...
    EXPECT_EQ(result, "check permission denied, need to request ohos.permission.REQUIRE_FORM "
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormMgrTest, FormMgr_UpdateFormCrossBundle_ConnectFailed_001, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "FormMgr_UpdateFormCrossBundle_ConnectFailed_001 begin";
    sptr<MockSystemAbilityManager> mockSamgr = new (std::nothrow) MockSystemAbilityManager();
    ASSERT_NE(mockSamgr, nullptr);
    sptr<ISystemAbilityManager> backupSamgr =
 ...
 * @tc.type: FUNC
 */
HWTEST_F(FormMgrTest, FormMgr_UpdateFormCrossBundle_RemoteProxyNull_002, TestSize.Level1)
{
