...
/**
 * @tc.name: FormRecordReport_013
 * @tc.desc: test GetFormRecords function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_013, TestSize.Level1)
{
    formRecordReport.SetFormRecordRecordInfo(TEST_FORM_ID, want);
    auto it = formRecordReport.GetFormRecords().find(TEST_FORM_ID);
    ASSERT_NE(it, formRecordReport.GetFormRecords().end());
...
/**
 * @tc.name: FormRecordReport_014
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_014, TestSize.Level1)
{
    formRecordReport.SetFormRecordRecordInfo(TEST_FORM_ID, want);
    formRecordReport.IncreaseUpdateTimes(TEST_FORM_ID, TYPE_DAILY_REFRESH);
    auto it = formRecordReport.GetFormRecords().find(TEST_FORM_ID);
...
/**
 * @tc.name: FormRecordReport_015
 * @tc.desc: test clearReportInfo function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_015, TestSize.Level1)
{
    formRecordReport.SetFormRecordRecordInfo(TEST_FORM_ID, want);
    formRecordReport.ClearReportInfo();
    EXPECT_TRUE(formRecordReport.GetFormRecords().empty());
...
/**
 * @tc.name: FormRecordReport_016
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_016, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.invisibleRefreshTimes = 0;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_017
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_017, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.hfRefreshBlockTimes = 0;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_018
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_018, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.invisibleRefreshBlockTimes = 0;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_019
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_019, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.highLoadRefreshBlockTimes = 1;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_020
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_020, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.activeRecoverRefreshTimes = 1;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_021
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_021, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.passiveRecoverRefreshTimes = 0;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_022
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_022, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.hfRecoverRefreshTimes = 0;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_023
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_023, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.offloadRecoverRefreshTimes = 1;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_024
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_024, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.bundleName = "bundleName";
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_025
 * @tc.desc: test GetFormRecords function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_025, TestSize.Level1)
{
    formRecordReport.SetFormRecordRecordInfo(TEST_FORM_ID, want);
    auto it = formRecordReport.GetFormRecords().find(TEST_FORM_ID);
    ASSERT_NE(it, formRecordReport.GetFormRecords().end());
...
/**
 * @tc.name: FormRecordReport_026
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_026, TestSize.Level1)
{
    formRecordReport.SetFormRecordRecordInfo(TEST_FORM_ID, want);
    formRecordReport.IncreaseUpdateTimes(TEST_FORM_ID, TYPE_DAILY_REFRESH);
    auto it = formRecordReport.GetFormRecords().find(TEST_FORM_ID);
...
/**
 * @tc.name: FormRecordReport_027
 * @tc.desc: test clearReportInfo function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_027, TestSize.Level1)
{
    formRecordReport.SetFormRecordRecordInfo(TEST_FORM_ID, want);
    formRecordReport.ClearReportInfo();
    EXPECT_TRUE(formRecordReport.GetFormRecords().empty());
...
/**
 * @tc.name: FormRecordReport_028
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_028, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.invisibleRefreshTimes = 0;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_029
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_029, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.hfRefreshBlockTimes = 0;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_030
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_030, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.invisibleRefreshBlockTimes = 0;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_031
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_031, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.highLoadRefreshBlockTimes = 1;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_032
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_032, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.activeRecoverRefreshTimes = 1;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_033
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_033, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.passiveRecoverRefreshTimes = 0;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_034
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_034, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.hfRecoverRefreshTimes = 0;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_035
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_035, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.offloadRecoverRefreshTimes = 1;
    int64_t formId = 1;
...
/**
 * @tc.name: FormRecordReport_036
 * @tc.desc: test IncreaseUpdateTimes function.
 * @tc.type: FUNC
 */
HWTEST_F(FormRecordReportTest, FormRecordReport_036, TestSize.Level1)
{
    FormRecordReportInfo formRecordReportInfo;
    formRecordReportInfo.bundleName = "bundleName";
    int64_t formId = 1;
