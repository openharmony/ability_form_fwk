 ...
 * CaseDescription: add data by input param.
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_022, TestSize.Level0)
{
 ...
 * CaseDescription: cache contains data and add the new data by input param.
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_023, TestSize.Level0)
{
 ...
 * CaseDescription: delete data by input key
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_024, TestSize.Level0)
{
 ...
 * EnvConditions: Mobile that can run ohos test framework
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_025, TestSize.Level0)
{
 ...
 * EnvConditions: Mobile that can run ohos test framework
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_026, TestSize.Level0)
{
 ...
 * EnvConditions: Mobile that can run ohos test framework
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_027, TestSize.Level0)
{
 ...
 * EnvConditions: Mobile that can run ohos test framework
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_028, TestSize.Level0)
{
 ...
 * EnvConditions: Mobile that can run ohos test framework
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_029, TestSize.Level0)
{
 ...
 * EnvConditions: Mobile that can run ohos test framework
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_030, TestSize.Level0)
{
 ...
 * EnvConditions: Mobile that can run ohos test framework
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_031, TestSize.Level0)
{
 ...
 * EnvConditions: Mobile that can run ohos test framework
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_032, TestSize.Level0)
{
    HILOG_INFO("FmsFormCacheMgrTest_032 start");
    std::vector<uint8_t> value;
    int32_t size = 1;
    int64_t rowId = 0;
    EXPECT_TRUE(formCacheMgr_.SaveImgCacheToDb(value, size, rowId));
    GTEST_LOG_(INFO) << "FmsFormCacheMgrTest_032 end";
}
 ...
 * EnvConditions: Mobile that can run ohos test framework
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_033, TestSize.Level0)
{
    HILOG_INFO("FmsFormCacheMgrTest_033 start");
    std::string rowId;
    EXPECT_FALSE(formCacheMgr_.DeleteImgCacheInDb(rowId));
    rowId = "rowId";
    EXPECT_TRUE(formCacheMgr_.DeleteImgCacheInDb(rowId));
    GTEST_LOG_(INFO) << "FmsFormCacheMgrTest_033 end";
}
 ...
 * CaseDescription: cache contains data and add the new data by input param.
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_034, TestSize.Level0)
{
    HILOG_INFO("FmsFormCacheMgrTest_034 start");
    std::string result1 = "{\"a\":\"1\",\"b\":\"2\"}";
    std::string result2 = "{\"a\":\"2\",\"b\":\"2\"}";
    nlohmann::json dataResult1 = R"(
        {
    ...
    EXPECT_TRUE(formCacheMgr_.GetData(PARAM_FORM_ID_FIRST, queryResult, imageDataMap));
    EXPECT_EQ(result2, queryResult);
    GTEST_LOG_(INFO) << "FmsFormCacheMgrTest_034 end";
}
 ...
 * CaseDescription: cache contains data and add the new data by input param.
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_035, TestSize.Level0)
{
    HILOG_INFO("FmsFormCacheMgrTest_035 start");
    std::string result1 = "{\"a\":\"1\",\"b\":\"2\"}";
    std::string result2 = "{\"a\":\"2\",\"b\":\"2\"}";
    nlohmann::json dataResult1 = R"(
        {
    ...
    EXPECT_TRUE(formCacheMgr_.GetData(PARAM_FORM_ID_FIRST, queryResult, imageDataMap));
    EXPECT_EQ(result2, queryResult);
    GTEST_LOG_(INFO) << "FmsFormCacheMgrTest_035 end";
}
/*
 * Feature: FormCacheMgr
 * Function: AddData
 ...
 * CaseDescription: cache contains data and add the new data by input param.
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_036, TestSize.Level0)
{
    HILOG_INFO("FmsFormCacheMgrTest_036 start");
    std::string result1 = "{\"a\":\"1\",\"b\":\"2\"}";
    std::string result2 = "{\"a\":\"2\",\"b\":\"2\"}";
    nlohmann::json dataResult1 = R"(
        {
    ...
    EXPECT_TRUE(formCacheMgr_.GetData(PARAM_FORM_ID_FIRST, queryResult, imageDataMap));
    EXPECT_EQ(result2, queryResult);
    GTEST_LOG_(INFO) << "FmsFormCacheMgrTest_036 end";
}
 ...
 * CaseDescription: cache contains data and add the new data by input param.
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_037, TestSize.Level0)
{
    HILOG_INFO("FmsFormCacheMgrTest_037 start");
    std::string result1 = "{\"a\":\"1\",\"b\":\"2\"}";
    std::string result2 = "{\"a\":\"2\",\"b\":\"2\"}";
    nlohmann::json dataResult1 = R"(
        {
    ...
    EXPECT_TRUE(formCacheMgr_.GetData(PARAM_FORM_ID_FIRST, queryResult, imageDataMap));
    EXPECT_EQ(result2, queryResult);
    GTEST_LOG_(INFO) << "FmsFormCacheMgrTest_037 end";
}
 ...
 * CaseDescription: cache contains data and add the new data by input param.
 */
 HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_038, TestSize.Level0)
 {
    HILOG_INFO("FmsFormCacheMgrTest_038 start");
    std::string result1 = "{\"a\":\"1\",\"b\":\"2\"}";
    std::string result2 = "{\"a\":\"2\",\"b\":\"2\"}";
    nlohmann::json dataResult1 = R"(
        {
    ...
    EXPECT_TRUE(formCacheMgr_.GetData(PARAM_FORM_ID_FIRST, queryResult, imageDataMap));
    EXPECT_EQ(result2, queryResult);
    GTEST_LOG_(INFO) << "FmsFormCacheMgrTest_038 end";
}
 ...
 * CaseDescription: cache contains data and add the new data by input param.
 */
HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_039, TestSize.Level0)
{
    HILOG_INFO("FmsFormCacheMgrTest_039 start");
    std::string result1 = "{\"a\":\"1\",\"b\":\"2\"}";
    std::string result2 = "{\"a\":\"2\",\"b\":\"2\"}";
    nlohmann::json dataResult1 = R"(
        {
    ...
    EXPECT_TRUE(formCacheMgr_.GetData(PARAM_FORM_ID_FIRST, queryResult, imageDataMap));
    EXPECT_EQ(result2, queryResult);
    GTEST_LOG_(INFO) << "FmsFormCacheMgrTest_039 end";
}
 ...
 * CaseDescription: cache contains data and add the new data by input param.
 */
 HWTEST_F(FmsFormCacheMgrTest, FmsFormCacheMgrTest_040, TestSize.Level0)
{
    HILOG_INFO("FmsFormCacheMgrTest_040 start");
    std::string result1 = "{\"a\":\"1\",\"b\":\"2\"}";
    std::string result2 = "{\"a\":\"2\",\"b\":\"2\"}";
    nlohmann::json dataResult1 = R"(
        {
    ...
    EXPECT_TRUE(formCacheMgr_.GetData(PARAM_FORM_ID_FIRST, queryResult, imageDataMap));
    EXPECT_EQ(result2, queryResult);
    GTEST_LOG_(INFO) << "FmsFormCacheMgrTest_040 end";
}
