...
/**
 * @tc.number: FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_009
 * @tc.name: NotifyVisibleForms
 * @tc.desc: Verify that the return code is ERR_APPEXECFWK_FORM_INVALID_PARAM.
 * @tc.info: The callerToken is nullptr.
 */
HWTEST_F(FmsFormMgrNotifyVisibleFormsTest, FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_009, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_009 start";
    ...
    GTEST_LOG_(INFO) << "FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_009 end";
}

/**
 * @tc.number: FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_010
 * @tc.name: NotifyVisibleForms
 * @tc.desc: Verify that the return value is ERR_OK.
 * @tc.info: Create two formId and push formIds, but only create one form record.
 */
HWTEST_F(FmsFormMgrNotifyVisibleFormsTest, FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_010, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_010 start";
    ...
    GTEST_LOG_(INFO) << "FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_010 end";
}

/**
 * @tc.number: FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_011
 * @tc.name: NotifyVisibleForms
 * @tc.desc: Verify that the return value is ERR_OK.
 * @tc.info: Create two formId and push formIds, but only create one form host record.
 */
HWTEST_F(FmsFormMgrNotifyVisibleFormsTest, FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_011, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_011 start";
    ...
    GTEST_LOG_(INFO) << "FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_011 end";
}

/**
 * @tc.number: FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_012
 * @tc.name: NotifyVisibleForms
 * @tc.desc: Verify that the return value is ERR_OK.
 * @tc.info: Create two formId and push formIds, two form records and two form host records.
 */
HWTEST_F(FmsFormMgrNotifyVisibleFormsTest, FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_012, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_013 start";
    ...
    EXPECT_EQ(ERR_OK, FormMgr::GetInstance().NotifyWhetherVisibleForms(formIds, token_, Constants::FORM_VISIBLE));
    GTEST_LOG_(INFO) << "FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_012 end";
}
...
HWTEST_F(FmsFormMgrNotifyVisibleFormsTest, FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_006, TestSize.Level0)
{
    ...
    EXPECT_EQ(ERR_OK, FormMgr::GetInstance().NotifyWhetherVisibleForms(formIds, token_, Constants::FORM_VISIBLE));
    GTEST_LOG_(INFO) << "FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_013 end";
}

/**
 * @tc.number: FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_014
 * @tc.name: NotifyVisibleForms
 * @tc.desc: Verify that the return value is ERR_OK.
 * @tc.info: The FormVisibleNotify is false.
 */
HWTEST_F(FmsFormMgrNotifyVisibleFormsTest, FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_014, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_014 start";
    ...
    EXPECT_EQ(ERR_OK, FormMgr::GetInstance().NotifyWhetherVisibleForms(formIds, token_, Constants::FORM_VISIBLE));
    GTEST_LOG_(INFO) << "FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_014 end";
}

/**
 * @tc.number: FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_015
 * @tc.name: NotifyVisibleForms
 * @tc.desc: Verify that the return value is ERR_OK.
 * @tc.info: The form provider is not a system app.
 */
HWTEST_F(FmsFormMgrNotifyVisibleFormsTest, FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_015, TestSize.Level0)
{
    GTEST_LOG_(INFO) << "FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_015 start";
    ...
    AccessToken::AccessTokenKit::GrantPermission(tokenId, PERMISSION_NAME_REQUIRE_FORM, flag);
    EXPECT_EQ(ERR_OK, FormMgr::GetInstance().NotifyWhetherVisibleForms(formIds, token_, Constants::FORM_VISIBLE));
    GTEST_LOG_(INFO) << "FmsFormMgrNotifyVisibleFormsTest_NotifyVisibleForms_015 end";
}
}
